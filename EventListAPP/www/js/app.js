...
.run(function ($ionicPlatform, $rootScope, $state, $location, $timeout, $ionicPopup, $ionicHistory, $ionicLoading, $cordovaToast, $cordovaFile) {
...
.config(function($stateProvider, $urlRouterProvider) {
  $stateProvider
    ...
    .state('detail', {
        url: '/detail/:ContainerNo/:JobNo/:JobLineItemNo/:LineItemNo/:Description/:Remark',
        cache:'false',
